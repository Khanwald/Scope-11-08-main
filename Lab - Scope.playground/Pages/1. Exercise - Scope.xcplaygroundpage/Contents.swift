...
//print("The value of foo is \(foo)")
//The variable foo only exists inside the loop
...
// x is a global variable meaning when its changed inside the loop, the variable is accessible outside.
...
greeting(greeting: nil, name: "Catherine")
greeting(greeting: "Hey there", name: "Samantha")
